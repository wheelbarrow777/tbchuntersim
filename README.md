...
TBC Hunter Sim is a simulator for the hunter class in World of Warcraft - The Burning Crusade. It's a command-line utility that focuses on simulation fast and accurate results, allowing for different simulation presets to be passed. 
...
Flags:
  ...
  -w, --simulation-workers int          Number of simulation workers to run in parallel (default 16)
